...
async def test_current_weather_imperial(
    ...
    header = CurrentWeather(mock_location, "zip", "27455", "imperial", True)
...
async def test_current_weather_metric(
    ...
    monkeypatch.setattr(AsyncClient, "get", mock_get_response)
    header = CurrentWeather(mock_location, "zip", "27455", "metric", False)
...
async def test_daily_weather_metric(
    ...
    monkeypatch.setattr(AsyncClient, "get", mock_get_response)
    header = DailyWeather(mock_location, "zip", "27455", "metric", False)
...
async def test_hourly_weather_imperial(
    ...
    monkeypatch.setattr(AsyncClient, "get", mock_get_response)
    header = HourlyWeather(mock_location, "zip", "27455", "imperial", True)
...
async def test_hourly_weather_metric(
    ...
    monkeypatch.setattr(AsyncClient, "get", mock_get_response)
    header = HourlyWeather(mock_location, "zip", "27455", "metric", False)
